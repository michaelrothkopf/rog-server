...
const dbUrl = process.env.ROG_NODE_DB_URL;
...
const adminPassword = process.env.ROG_NODE_ADMIN_PASSWORD;
...
const prodPort = process.env.ROG_NODE_PROD_PORT;
